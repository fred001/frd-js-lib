...
set nomore
set report=0
set runtimepath=~/.vim,~/.vim/bundle/L9,~/.vim/bundle/Vundle.vim,~/.vim/bundle/command-t,~/.vim/bundle/html5.vim,~/.vim/bundle/sparkup,~/.vim/bundle/syntastic,~/.vim/bundle/vim-fugitive,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=3
...
silent only
cd /var/www/html/unicorn/resource/js/frd
